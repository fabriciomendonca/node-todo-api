...
describe('Test GET /todos/:id', () => {
  ...
  it('should not return a todo doc craeted by other user', (done) => {
    request(app)
...
describe('POST /users', () => {
  ...
  it('should return validation errors if reques invalid', (done) => {
    request(app)
      .post('/users')
      .send({ email: 'email', password: '234' })
      .expect(400)
      .end(done);
  });
...
describe('POST /users/login', () => {
  ...
  it('shoul reject invalid login', (done) => {
    request(app)
      .post('/users/login')
      .send({
